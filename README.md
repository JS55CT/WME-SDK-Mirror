...
There are **5 scripts**, run in this order every time you update the SDK mirror:
...
After the run, the `NotebookLM/` folder contains everything you need. Load these files
into your LLM context (NotebookLM, Claude, etc.):
